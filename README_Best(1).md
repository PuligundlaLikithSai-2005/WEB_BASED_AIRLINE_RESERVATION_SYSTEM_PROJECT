...
[![Java](https://img.shields.io/badge/Java-Swing-orange?style=for-the-badge&logo=java)](https://www.java.com/)
[![GUI](https://img.shields.io/badge/GUI-Java%20Swing-blue?style=for-the-badge)](https://docs.oracle.com/javase/tutorial/uiswing/)
[![Repository](https://img.shields.io/badge/GitHub-Repository-black?style=for-the-badge&logo=github)](https://github.com/PuligundlaLikithSai-2005/Web-Based-Airline-Reservation-System)
...
| Feature | Description |
|---|---|
| 🌍 Flight Selection | Select the departure location and destination |
| 💺 Class Selection | Economic and Business class options |
| 👨‍👩‍👧 Passenger Details | Adults, children, and infants can be selected |
| 📅 Booking Date | Enter the travel/booking date |
| 💰 Fare Calculation | Calculates price based on class and passenger count |
| 🪑 Seat Availability | Checks whether seats are available before booking |
| 🎫 Ticket Generation | Creates a ticket through `PrintTicket1` |
| 💾 Booking Storage | Stores booking data using Java serialization |
| 🖼️ Travel UI | Uses `map1.jpg` and `note_bg.gif` as interface images |
